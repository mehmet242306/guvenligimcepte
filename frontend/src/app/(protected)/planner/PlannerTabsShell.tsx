...
import { Calendar, FileText, GraduationCap, ClipboardList, ClipboardCheck } from "lucide-react";
...
import PeriodicControlsRegisterTab from "./PeriodicControlsRegisterTab";
...
type TabKey = "planlayici" | "yillik-calisma" | "yillik-egitim" | "periyodik-kontrol" | "puantaj";
...
const TABS: { key: TabKey; icon: typeof Calendar; labelKey: string; descKey: string }[] = [
  ...
  { key: "periyodik-kontrol", icon: ClipboardCheck, labelKey: "tabs.periodicControls.label", descKey: "tabs.periodicControls.desc" },
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        {active === "periyodik-kontrol" && <PeriodicControlsRegisterTab />}
