/**
 * Merges scripts/i18n-packs/public-flows/{locale}.json into messages/{locale}.json.
 * Missing locale files fall back to en.json so keys always exist.
 * Run: node scripts/merge-public-flows-i18n.mjs
 */
...
const packDir = path.join(__dirname, "i18n-packs", "public-flows");
