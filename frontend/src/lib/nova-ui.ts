...
const trCopy: NovaUiCopy = {
  ...
  widget: {
    welcomeAuthenticated:
      "Merhaba! Ben Nova. İSG mevzuatı sorularınızı yanıtlayabilir ve sizi RiskNova'daki doğru modül veya sayfaya yönlendirebilirim.",
    welcomePublic:
      "Merhaba! Gerçek Nova ajanına erişmek için giriş yapmanız gerekir. İsterseniz hemen oturum açın veya hesap oluşturun.",
    publicLocked:
      "Gerçek Nova ajanına erişmek için giriş yapın. Girdikten sonra Nova bu sohbet penceresinden İSG sorularınızı yanıtlar ve sizi doğru ekrana yönlendirir.",
    initializing: "Lütfen bir saniye, Nova hazırlanıyor...",
    unavailable:
      "Nova şu anda cevap veremiyor. Lütfen biraz sonra tekrar deneyin.",
    redirecting: (label) => `${label} sayfasına yönlendiriliyorsunuz...`,
    subtitle: "AI İSG Asistanı",
    openAriaLabel: "Nova asistanını aç",
    minimizeAriaLabel: "Küçült",
    ...
    safetyBlockLabel: "Güvenlik Kısıtlaması",
    continueInWorkspace: "İlgili ekranda devam et",
    approveAction: "Onayla",
    cancelAction: "İptal Et",
    yesReply: "Evet",
    noReply: "Hayır",
    actionRunning: "İşleniyor...",
    ...
    navHelp: "Yardım",
    newChat: "Yeni sohbet",
    newChatAriaLabel: "Yeni sohbet başlat",
  },
};
