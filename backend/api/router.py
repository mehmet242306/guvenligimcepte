...
from api.v1.endpoints.company_workspaces import router as company_workspaces_router
...
from api.v1.endpoints.risk_assessments import router as risk_assessments_router
from api.v1.endpoints.vision_detect import router as vision_detect_router
...
api_router.include_router(company_workspaces_router)
api_router.include_router(risk_assessments_router)
api_router.include_router(vision_detect_router)
