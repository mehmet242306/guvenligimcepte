...
export default function SolutionCenterLayout({
  ...
  return (
    <div className="flex flex-col gap-4">
      <nav className="flex flex-col gap-3 rounded-2xl border border-border bg-card p-3 shadow-[var(--shadow-soft)] sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-primary">
            Nova Workspace
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
            Sor, yonlendir, belge olustur ve operasyon aksiyonlarini tek alanda takip et.
          </p>
        </div>
