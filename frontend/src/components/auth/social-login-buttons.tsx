...
export function SocialLoginButtons({ mode = "login", nextPath }: SocialLoginProps) {
  ...
  const appleLabel =
    mode === "register"
      ? ts("appleSignUp", { brand: brandName })
      : ts("appleContinue", { brand: brandName });
  ...
  const providers = [
    ...
    },
    {
      ...
      label: appleLabel,
      Icon: AppleIcon,
      cls: "border-zinc-950 bg-zinc-950 text-white hover:bg-zinc-800 dark:border-white dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200",
    },
  ];
